...
export async function EditInstalacionesHorario(d:EditInstalacionesPreciosRequest){
  const res = await fetch(`${LOCAL_URL}/api/establecimiento/instalacion/horario`,{
    method:"POST",
