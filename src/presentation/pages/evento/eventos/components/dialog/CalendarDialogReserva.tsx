...
import SelectTime from "@/presentation/util/select/SelectTime"
import { days } from "@/context/actions/chart-actions"
import { GetInstalaciones } from "@/core/repository/instalacion"
import { Repeat, EndOptions, ReservaType, MonthDaySelectOption, DayMonthPosition, Http } from "@/data/model/types/enums"
...
import InputDate from "@/presentation/util/input/InputDate"
...
const CalendarDialogReserva = ({close,open,startDate,startTime,uuid,reserva_type,uuidEvent,
    ...
    const [end,setEnd] = useState(startTime?.add(30,"minutes"))
