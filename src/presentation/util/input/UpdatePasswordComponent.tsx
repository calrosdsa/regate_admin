    ...
    <div>
      <div className=" flex justify-between items-center space-x-5 py-3 divider">
        <div className="grid">
          ...
          <Typography variant="subtitle1">
            {last_updated_password != undefined
              ? moment(last_updated_password).utc().format("LLLL")
              : ""}
          </Typography>
          {/* <span className="text-sm">{last_updated_password != undefined ? moment(last_updated_password).utc().format('LLLL'):""}</span> */}
        </div>
        <Button onClick={() => setShow(!show)} color="inherit">
          Actualizar
        </Button>
      </div>
      <Transition
      ...
      >
        <form onSubmit={onSubmit} className="grid gap-y-3 mt-3">
          <div>
          <Typography variant="body2" sx={{mb:0.5}}>Contraseña actual</Typography>
            <TextField
              size="small"
          ...
          <div>
          <Typography variant="body2" sx={{mb:0.5}}>Nueva contraseña</Typography>
          <TextField
            size="small"
          ...
          />
            ...
            <div>
          <Typography variant="body2" sx={{mb:0.5}}>Repetir nueva contraseña</Typography>
          <TextField
            size="small"
          ...
          <ButtonSubmit loading={loading} title="Actualizar contraseña" />
        </form>
      </Transition>
    </div>
  );
